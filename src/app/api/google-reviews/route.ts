...
const RECENT_10_GOOGLE_REVIEWS = [
  {
    ...
    text: 'Best handloom saree manufacturer in Maheshwar! The pure silk checks and Garbha Reshami border sarees are outstanding. Genuine price, fast courier delivery to Mumbai.',
    city: 'Mumbai, MH',
  ...
  },
  {
    ...
    text: 'Beautiful traditional saree with reversible Garbha Reshami border. Packing was sturdy and shipping was very quick.',
    city: 'Surat, GJ',
    saree_image: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=400&q=80',
  },
  {
